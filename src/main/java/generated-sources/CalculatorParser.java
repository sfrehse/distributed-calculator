...
public class CalculatorParser extends Parser {
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public TerminalNode FN_NAME() { return getToken(CalculatorParser.FN_NAME, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case FN_NAME:
				{
				setState(13);
				((ExprContext)_localctx).fnName = match(FN_NAME);
				setState(14);
				match(T__0);
				{
				setState(15);
				((ExprContext)_localctx).expr = expr(0);
				((ExprContext)_localctx).arguments.add(((ExprContext)_localctx).expr);
				setState(20);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__2) {
